  ...
  return (
    <div className="min-h-screen relative font-sans text-zinc-900 bg-[#f8f5f0] overflow-hidden flex flex-col justify-center">
      ...
      >
        ...
        <div className="w-full max-w-[1200px] mx-auto px-10 sm:px-14 md:px-16 lg:px-24 flex flex-col md:flex-row items-center md:items-center justify-between gap-12 lg:gap-20">
      ...
      <footer
        className="w-full bg-transparent text-[#27351d] text-center font-semibold tracking-wide z-10 relative opacity-70 px-6"
        style={{ 
          paddingBottom: '80px', 
          fontSize: '11px',
          lineHeight: '1.6'
      ...
      >
        &copy; {new Date().getFullYear()} Lacustre Hall. <br className="sm:hidden" /> Todos os direitos reservados.
      </footer>
    </div>
  );
}
